...
function mostrar(){
	...
	if (btnmenu == true){
		...
		var contenido_BR = document.getElementById('contenido_BR').style.margin="0 200px";
		var contenido_APK = document.getElementById('contenido_APK').style.margin="0 200px";
		var contenido_APKJ = document.getElementById('contenido_APKJ').style.margin="0 200px";
		var contenido_EMU = document.getElementById('contenido_EMU').style.margin="0 200px";
		var contenido_PROG = document.getElementById('contenido_PROG').style.margin="0 200px";
	}else {
		...
		var contenido_BR = document.getElementById('contenido_BR').style.margin="0 0";
		var contenido_APK = document.getElementById('contenido_APK').style.margin="0 0";
		var contenido_APKJ = document.getElementById('contenido_APKJ').style.margin="0 0";
		var contenido_EMU = document.getElementById('contenido_EMU').style.margin="0 0";
		var contenido_PROG = document.getElementById('contenido_PROG').style.margin="0 0";
	}
}
